...
class DiamondFragment extends StatefulWidget {
  @override
  _DiamondFragmentState createState() => _DiamondFragmentState();
}

class _DiamondFragmentState extends State<DiamondFragment> {
  ...
  void initState() {
   ...
   Future<void> fetchNewProducts() async {
    final response = await http.get(Uri.parse('https://192.168.220.48/art/get_new_diamond.php')); // Remplacez par votre URL de l'API
  ...
  Future<void> fetchProducts() async {
    final response = await http.get(Uri.parse('https://192.168.220.48/art/get_diamond.php')); // Remplacez par votre URL de l'API
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Vatosoa', style: TextStyle(color: Colors.black),),
      ),
